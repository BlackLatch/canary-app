                ...
                <div className="space-y-4 max-w-sm mx-auto mb-16">
                  ...
                  <div className="text-center">
                    ...
                    <div className="space-y-3">
                      ...
                      {/* Import Local Account - Always Available */}
                      <button
                        className={`w-full py-4 px-6 font-medium text-base rounded-lg transition-all duration-300 ease-out disabled:opacity-50 disabled:cursor-not-allowed border ${
                          theme === "light"
                            ? "bg-white text-gray-900 border-gray-300 hover:border-[#e53e3e] hover:bg-gray-50"
                        ...
                        title="Import a local account using your private key"
                      >
                        <div className="flex items-center justify-center gap-2">
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <span>Import Local Account</span>
                        </div>
                      </button>
                                      ...
                                      return (
                                        ...
                                        >
                                          ...
                                          <div className="flex-1 mb-4">
                                            {/* Release Visibility Indicator & Guardian Badge */}
                                            ...
                                            <div className="text-center">
                                              ...
                                              <div
                                                className={`${timeColor} monospace-accent text-xl font-bold flex items-center justify-center gap-2`}
                                              >
                                                {(timeDisplay.includes('EXPIRED') || timeDisplay.includes('GRACE PERIOD') || timeDisplay.includes('MANUALLY RELEASED')) && (
                                                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                                                  </svg>
                                                )}
                                                <span>{timeDisplay.replace('⚠ ', '')}</span>
                                              </div>
